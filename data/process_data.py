...
def load_data(messages_filepath, categories_filepath):
    """Loads dataframe from filepaths
...
def clean_data(df):
    """Cleans data included in the DataFrame and transforms categories part
...
def main():
    """Runs main function: Loads the data, cleans it and saves it in a database"""
